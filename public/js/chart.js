function addGraph(rawPlotData){
  var plotData = rawPlotData.plotData;
  var plotCenterText = rawPlotData.plotCenterText;
  var div = d3.select("body").append("div").attr("class", "toolTip");
      ...
      center_group.selectAll('text').data([total]).enter().append('text').text(function(d){
                  return plotCenterText;
                  }).attr('class','value').attr('dy', 8).attr('text-anchor', 'end').attr('transform', 'translate(45, 10)');
      }
